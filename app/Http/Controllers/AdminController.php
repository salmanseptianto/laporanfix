...
class AdminController extends Controller
{
    ...
    public function laporanMmHarian($type)
    {
        ...
        $harian = Harian::where('status', $status)->with('marketing')->get();
    ...
    public function laporanMmMingguan($type)
    {
        ...
        $mingguan = Mingguan::where('status', $status)->with('marketing')->get();
    ...
    public function laporanH()
    {
        return view('admin.manager.harian');
    }
    public function laporanM()
    {
        return view('admin.manager.mingguan');
    }
