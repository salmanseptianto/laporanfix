    ...
    <div class="container mx-auto px-8 py-6">
        <div class="grid grid-cols-1 gap-8">
            ...
            <div class="bg-white shadow-lg rounded-lg p-6 overflow-x-auto w-full">
                <h1 class="text-3xl font-semibold mb-6 text-blue-800 border-b-4 border-blue-400 pb-2">{{$title}}</h1>

                <div class="flex space-x-4">
                    <select id="projectDropdown" name="projectArea" class="border border-gray-300 rounded-lg px-4">
                    ...
                    <!-- Form Export Excel -->
                    <form action="{{ route('mingguan.export.excel', ['type' => $type === 'approve' ? 'terima' : 'tolak']) }}" method="GET"
                        id="excelExportForm" class="mb-4">
                    ...
                    <!-- Form Export PDF -->
                    <form action="{{ route('mingguan.export.pdf', ['type' => $type === 'approve' ? 'terima' : 'tolak']) }}" method="GET" id="pdfExportForm"
                        class="mb-4">
